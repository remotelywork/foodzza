...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $isBranch = getPageSetting('branch_validation') && getPageSetting('branch_show');
        ...
        $phone = $isPhone ? ($isCountry ? explode(':', $request->get('country'))[1] : $location->dial_code).' '.$request->get('phone') : $location->dial_code.' ';
