    ...
    'permission' => [
        ...
        'elements' => [
            [
                ...
                'name' => 'ads_system', // unique name for field
                'label' => 'Ads System', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => '0', // default value if you want
            ],
            [
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'boolean', // data type, string, int, boolean
                'name' => 'user_ads_post', // unique name for field
                'label' => 'User Ads Post', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => 1, // default value if you want
            ],
            [
                'type' => 'checkbox', // input fields type
                'data' => 'boolean', // data type, string, int, boolean
                'name' => 'ads_auto_approval', // unique name for field
                'label' => 'Ads Auto Approval', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => 1, // default value if you want
            ],
            [
    ...
    'ads' => [
        ...
        'elements' => [
            [
                ...
                'name' => 'link_ads_price', // unique name for field
                'label' => 'Link Ads Price', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'image_ads_price', // unique name for field
                'label' => 'Image Ads Price', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '2.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'script_ads_price', // unique name for field
                'label' => 'Script Ads Price', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '3.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'youtube_ads_price', // unique name for field
                'label' => 'Youtube Ads Price', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '4.25', // default value if you want
            ],
    
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'link_ads_amount', // unique name for field
                'label' => 'Link Ads Amount', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'image_ads_amount', // unique name for field
                'label' => 'Image Ads Amount', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'script_ads_amount', // unique name for field
                'label' => 'Script Ads Amount', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1.50', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'youtube_ads_amount', // unique name for field
                'label' => 'Youtube Ads Amount', // you know what label it is
                'rules' => 'required|numeric', // validation rule of laravel
                'value' => '1.50', // default value if you want
            ],
