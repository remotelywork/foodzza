...
<div class="page-header">
    <div class="dashboard-header">
        ...
        <div class="header-right-content">
            @if(auth()->user()->has('plan'))
            <div class="btn-wrap"> 
                <button class="site-btn primary-btn btn-xxs"><i class="icon-crown"></i>
                    {{ auth()->user()->plan?->name }}
                </button> 
            </div>
            @endif
            ...
            <div class="user-action">
                <ul>
                    ...
                    <li>
                        <button class="notification-box" data-bs-toggle="dropdown" aria-expanded="false"> <span class="icon"><i class="icon-notification"></i></span> <span class="number-badge">{{ $totalUnread }}</span> </button>
