        ...
        <div class="row gy-30 align-items-center">
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="invite-thumb-wrap">
                    ...
                    <div class="earn-card">
                        @php
                            $text = $data['left_bottom_text'];
                            $splitText = explode(' ', $text);
                        @endphp
                        <p>{{ $splitText[0] }} <br> {{ $splitText[1] }}</p>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="invite-content">
                    ...
                    <div class="btn-inner">
                        <a class="site-btn primary-btn btn-xs" href="{{ $data['invite_button_url'] }}">{{ $data['invite_button_level'] }} <i class="{{ $data['invite_button_icon'] }}"></i>
                        </a>
                    </div>
                </div>
            </div>
