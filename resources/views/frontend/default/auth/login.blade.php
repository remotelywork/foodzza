                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="single-input has-left-icon">
                            ...
                            <div class="input-field">
                                <input type="email" name="email" class="box-input email-input" required value="{{ old('email') }}" placeholder="{{ __('Enter email') }}">
                                <span class="icon">
                                    <i class="icon-sms"></i>
                                </span>
                            </div>
                        ...
                        <div class="single-input has-right-icon has-left-icon">
                            ...
                            <div class="input-field">
                                ...
                                <div class="password">
                                    <img src="{{ asset('frontend/default/images/icons/eye-off.svg') }}" class="password-hide-show eyeicon"
                                        alt="">
                                </div>
                                <span class="icon">
                                    <i class="icon-lock"></i>
                        ...
                        <div class="remember-content">
                            <div class="custom-checkbox">
                                <input class="inp-cbx" id="check-sign-in" type="checkbox" name="remember_me" style="display: none;" />
