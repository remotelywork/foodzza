                ...
                <div class="fund-transfer-history">
                    <div class="site-card-header">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                            <h3 class="site-card-title mb-0">{{ __('Deposit History') }}</h3>
                            <a href="{{ route('user.deposit.amount') }}" class="site-btn primary-btn"><i class="icon-repeat-circle"></i>{{ __('Deposit') }}</a>
                        </div>
                    </div>
                            ...
                            <form action="" method="GET">
                                <div class="fund-transfer-history-field">
                                    <div class="input-field">
                                        <input type="text" class="box-input" name="trx" value="{{ request('trx') }}" placeholder="{{ __('Transaction ID') }}">
                                    </div>
                                    <div class="input-field">
