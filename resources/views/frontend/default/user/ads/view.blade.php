...
<body>
    ...
    <div class="mt-5 d-none" id="warningArea">
        <div class="text-center">
            ...
            <div class="my-4">
                <button type="button" class="input-btn btn-danger me-3" onclick="window.close();"> <i class="icon-close-circle"></i> {{ __('Close Tab') }}</button>
                <a href="{{ route('user.ads.index') }}" class="input-btn btn-primary"><i class="icon-arrow-left"></i> {{ __('Back') }}</a>
            </div>
        </div>
    </div>
            ...
            <div class="advertisement-card-wrapper d-flex flex-column gap-4">
                <div class="advertisement-card">
                    <div class="container pb-3">
                        ...
                        <div class="input-btn-wrap mt-3" id="reportArea">
                            <button class="input-btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#reportModal">
                                <span>
    ...
    <div class="modal fade" id="reportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('user.ads.report.submit',encrypt($ads->id)) }}" method="post">
                    @csrf
   ...
   <div class="advertisement-field w-100 mx-3 my-2">
        ...
        <iframe allow="autoplay" src="{{ $ads->value }}?autoplay=1"></iframe>
      ...
      (function ($) {
        ...
        window.addEventListener("load", function () {
            ...
            progressItems.forEach(item => {
                ...
                const durationInSeconds = "{{ $ads->duration }}"; // Total duration of the animation in seconds
                const intervalTimeInMilliseconds = durationInSeconds * 10; // Convert duration to match the interval logic
