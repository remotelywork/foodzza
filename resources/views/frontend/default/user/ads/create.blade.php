...
<div class="ads-area">
    ...
    <form action="{{ route('user.my.ads.store') }}" method="post">
        @csrf
        <div class="row gy-30">
                        ...
                        <div class="row gy-25">
                            <div class="col-xxl-8">
                                <div class="single-input">
                                    ...
                                    <div class="input-field">
                                        <input type="text" class="box-input" name="title" value="{{ old('title') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6">
                                <div class="single-input">
                                    ...
                                    <div class="input-field">
                                        <input type="number" name="duration" class="box-input" value="{{ old('duration') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-6">
                                <div class="single-input">
                                    <label class="input-label" for="">{{ __('Max Show Limit') }}<span>*</span></label>
                                    <div class="input-field">
                                        <input type="number" class="box-input" name="max_show_limit" value="{{ old('max_show_limit') }}">
                                        <div class="text-content">
                                            <p class="note">{{ __('Note') }}: {{ $currencySymbol }}<span id="adsPrice"></span> {{ __(' is charged for each advertisement.') }}</p>
                                            <p class="note">{{ __('Total Charge') }} : {{ $currencySymbol }} <span class="total-charge">0</span> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-12">
                                <div class="add-schedule-wrapper">
                                    <div class="add-schedule-top">
                                        <div class="content">
                                            <p class="description">{{ __('Add Schedule (Optional)') }}</p>
                                            <button id="add-more" class="site-btn primary-btn btn-xxs" type="button"><i
                                                    class="icon-add-circle"></i>{{ __('Add') }}</button>
                                        </div>
                                    </div>
                                    <div id="schedule-items" class="add-schedule-item">
