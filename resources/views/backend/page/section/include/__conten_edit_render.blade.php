                    ...
                    <form action="{{ route('admin.page.content-update') }}" method="post" enctype="multipart/form-data">
                        ...
                        @if($key == 'en')
                            <div class="site-input-groups">
                                @if($landingContent['type'] == 'whychooseus' || $landingContent['type'] == 'about')
                                ...
                                @elseif($landingContent['type'] == 'workstepsection' || $landingContent['type'] == 'powerfulsection' || $landingContent['type'] == 'howitworks' || $landingContent['type'] == 'benefits' || $landingContent['type'] == 'funfact')
                        ...
                        @if($landingContent['type'] != 'about' && $landingContent['type'] != 'funfact')
                        ...
                        @if($landingContent['type'] == 'funfact')
                            <div class="site-input-groups mb-0">
