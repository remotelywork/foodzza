...
@section('title')
    {{ __('Benefits And Facilities Section') }}
@endsection
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Benefits And Facilities Section') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="site-card">
                                ...
                                <div class="site-card-body">
                                    <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                        ...
                                        @csrf
                                        <input type="hidden" name="section_code" value="benefits">
                                        ...
                                        <div class="site-input-groups row">
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-label">
                                                {{ __('Benefits Background Image') }} <small>(567x596)</small>
                                            </div>
                                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                                <div class="wrap-custom-file">
                                                    <input type="file" name="bg_img" id="heroRightImg"
                                                           accept=".gif, .jpg, .png"/>
                                                    <label for="heroRightImg" id="bg_img" @if($data->bg_img) class="file-ok"  style="background-image: url({{ asset($data->bg_img) }})" @endif>
                                                        <img class="upload-icon"
                                                             src="{{ asset('global/materials/upload.svg') }}" alt=""/>
                                                        <span>{{ __('Update Image') }}</span>
                                                    </label>
                                                    @removeimg($data->bg_img,bg_img)
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Benefits And Facilities Title Small') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for=""
                                                   class="col-sm-3 col-label">{{ __('Benefits And Facilities Title Big') }}</label>
                                            <div class="col-sm-9">
            ...
            <div class="site-card">
                <div class="site-card-header">
                    <h3 class="title">{{ __('Benefits And Facilities Contents') }}</h3>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.section.include.__add_new_benefit')
    <!-- Modal for Add New Benefit End -->

    <!-- Modal for Edit -->
    @include('backend.page.section.include.__edit_benefit')
    <!-- Modal for Edit  End-->

    <!-- Modal for Delete  -->
    @include('backend.page.section.include.__delete_benefit')
